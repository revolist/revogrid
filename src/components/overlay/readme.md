...
| `beforeapplyrange`     | Before range applied                                                                                                                                                                            | `CustomEvent<FocusRenderEvent>`                                                                                                                                               |
| `beforecelledit`       | Before cell edit happened                                                                                                                                                                       | `CustomEvent<{ prop: ColumnProp; model: DataType; val?: string; rowIndex: number; colIndex: number; colType: DimensionCols; type: DimensionRows; }>`                          |
| `beforecellfocusinit`  | Before cell focus                                                                                                                                                                               | `CustomEvent<{ prop: ColumnProp; model: DataType; val?: string; rowIndex: number; colIndex: number; colType: DimensionCols; type: DimensionRows; }>`                          |
...
| `focuscell`            | Cell get focused To prevent the default behavior of applying the edit data, you can call `e.preventDefault()`.                                                                                  | `CustomEvent<AllDimensionType & FocusedCells>`                                                                                                                                |
| `rangedataapplyinit`   | Range data apply                                                                                                                                                                                | `CustomEvent<{ data: DataLookup; models: { [rowIndex: number]: DataType; }; type: DimensionRows; }>`                                                                          |
...
| `settemprange`         | Set temp range area during autofill                                                                                                                                                             | `CustomEvent<{ type: string; area: RangeArea; }>`                                                                                                                             |
