...
| `dataStore`           | --                       | Row data store                                                                                | `ObservableMap<DataSourceState<DataType, DimensionRows>>`      | `undefined` |
...
| `setEdit`                  | Set edit cell                                                         | `CustomEvent<{ prop: ColumnProp; model: DataType; val?: string; rowIndex: number; type: DimensionRows; }>`                                            |
