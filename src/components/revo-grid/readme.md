...
| `colSize`            | `rgCol-size`         | Indicates default column size.                                                                                                                                                                                                                          | `number`                                                                                                                                  | `100`       |
...
| `rowClass`           | `rgRow-class`        | Row class property Define this property in rgRow object and this will be mapped as rgRow class                                                                                                                                                              | `string`                                                                                                                                  | `''`        |
| `rowDefinitions`     | --                 | Row properies applied                                                                                                                                                                                                                                   | `RowDefinition[]`                                                                                                                         | `[]`        |
| `rowHeaders`         | `rgRow-headers`      | Excel like show rgRow indexe per rgRow                                                                                                                                                                                                                      | `RowHeaders \| boolean`                                                                                                                   | `undefined` |
| `rowSize`            | `rgRow-size`         | Indicates default rgRow size. By default 0, means theme package size will be applied                                                                                                                                                                      | `number`                                                                                                                                  | `0`         |
