...
| `beforesourcesortingapply` | This event is triggered before the sorting is applied during the update of the source data. To prevent sorting data from changing during the update of the source rows, you can call `e.preventDefault()`.                                                                                                      | `CustomEvent<any>`                                                                                                                                                                                                                            |
