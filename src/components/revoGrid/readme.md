...
| --------------------------- | ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `applyEditorChangesOnClose` | `apply-editor-changes-on-close` | Apply changes typed in editor on editor close except Escape cases If custom editor in use @method getValue required                                                                                                                                     | `boolean`                                                                                                                                                                 | `false`     |
